package com.java.datastructure.Hexlet.test;

import com.java.datastructure.Hexlet.module.m03e02.ArrayBasedMap;
import com.java.datastructure.Hexlet.module.m03e02.Student;
...
public class ArrayBasedMapTest {
    ...
    @Test  public void testEntrySetForEmptyMap() {
        final Map<String, Student> map;
        try {
            map = makeEmptyMap();
        } catch (UnsupportedOperationException e) {
    ...
    @Test  public void testEntrySetContainsEntryNullKeyPresent() {
    ...
    @Test  public void testEntrySetContainsEntryNullKeyMissing() {
        final Map<String, Student> map;
        final Set<Entry<String, Student>> entrySet;
        try {
            map = makeEitherMap();
    ...
    @Test  public void testEntrySetRemoveMissingKey() {
        final Map<String, Student> map;
        final String key;
        try {
            map = makeEitherMap();
    ...
    @Test  public void testEntrySetRemoveDifferentValue() {
        final Map<String, Student> map;
        try {
            map = makePopulatedMap();
        } catch (UnsupportedOperationException e) {
    ...
    @Test  public void testEntrySetRemoveNullKeyPresent() {
    ...
    @Test  public void testEntrySetRemoveNullKeyMissing() {
        final Map<String, Student> map;
        try {
            map = makeEitherMap();
        } catch (UnsupportedOperationException e) {
    ...
    @Test  public void testEntrySetRemoveAllNullFromEmpty() {
        final Map<String, Student> map;
        try {
            map = makeEmptyMap();
        } catch (UnsupportedOperationException e) {
    ...
    @Test  public void testEntrySetRetainAllNullFromEmpty() {
        final Map<String, Student> map;
        try {
            map = makeEmptyMap();
        } catch (UnsupportedOperationException e) {
    ...
    @Test  public void testEntrySetClear() {
        final Map<String, Student> map;
        try {
            map = makePopulatedMap();
        } catch (UnsupportedOperationException e) {
    ...
    @Test  public void testEntrySetSetValue() {
    ...
    @Test  public void testEntrySetSetValueSameValue() {
        // TODO: Investigate the extent to which, in practice, maps that support
        // put() also support Entry.setValue().
        if (!supportsPut) {
            return;
    ...
    @Test  public void testEqualsForLargerMap() {
        if (!supportsPut) {
            return;
        }
    ...
    @Test  public void testEqualsForSmallerMap() {
        if (!supportsRemove) {
            return;
        }
    ...
    @Test  public void testGetForEmptyMap() {
        final Map<String, Student> map;
        String unmappedKey = null;
        try {
            map = makeEmptyMap();
    ...
    @Test  public void testHashCodeForEmptyMap() {
        final Map<String, Student> map;
        try {
            map = makeEmptyMap();
        } catch (UnsupportedOperationException e) {
    ...
    @Test  public void testPutNewKey() {
    ...
    @Test  public void testPutExistingKey() {
        final Map<String, Student> map;
        final String keyToPut;
        final Student valueToPut;
        try {
    ...
    @Test  public void testPutAllNewKey() {
        final Map<String, Student> map = makeEitherMap();
        final String keyToPut;
        final Student valueToPut;
        try {
    ...
    @Test  public void testPutAllExistingKey() {
        final Map<String, Student> map;
        final String keyToPut;
        final Student valueToPut;
        try {
    ...
    @Test  public void testRemoveMissingKey() {
        final Map<String, Student> map;
        final String keyToRemove;
        try {
            map = makePopulatedMap();
    ...
    @Test  public void testKeySetClear() {
        final Map<String, Student> map;
        try {
            map = makeEitherMap();
        } catch (UnsupportedOperationException e) {
    ...
    @Test  public void testKeySetRemoveAllNullFromEmpty() {
        final Map<String, Student> map;
        try {
            map = makeEmptyMap();
        } catch (UnsupportedOperationException e) {
    ...
    @Test  public void testKeySetRetainAllNullFromEmpty() {
        final Map<String, Student> map;
        try {
            map = makeEmptyMap();
        } catch (UnsupportedOperationException e) {
    ...
    @Test  public void testValuesRemoveMissing() {
        final Map<String, Student> map;
    ...
    @Test  public void testValuesRemoveAllNullFromEmpty() {
        final Map<String, Student> map;
        try {
            map = makeEmptyMap();
        } catch (UnsupportedOperationException e) {
    ...
    @Test  public void testValuesRetainAllNullFromEmpty() {
        final Map<String, Student> map;
        try {
            map = makeEmptyMap();
        } catch (UnsupportedOperationException e) {
    ...
    @Test  public void testValuesClear() {
        final Map<String, Student> map;
        try {
            map = makePopulatedMap();
        } catch (UnsupportedOperationException e) {
